var SwalService = function(s){
  this.pendingSwal=[],s&&null!=s.showPendingMessage&&(this.showPendingMessage=s.showPendingMessage),this.initialize()};
  
SwalService.prototype = {
  currentSwal:null,
  showPendingMessage:!0,
  swalFirstCalled:!1,
  __swal:swal,pendingSwal:null,
  nextId:1,
